...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.district'
        db.alter_column('pages_membership', 'district', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Membership.district'
        db.alter_column('pages_membership', 'district', self.gf('django.db.models.fields.CharField')(max_length=255))
