...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.role'
        db.alter_column('pages_membership', 'role', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Membership.role'
        db.alter_column('pages_membership', 'role', self.gf('django.db.models.fields.TextField')(null=True))
