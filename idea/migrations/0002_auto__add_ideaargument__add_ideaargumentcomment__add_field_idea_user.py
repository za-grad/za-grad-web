...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('idea_idea', 'user_id')
    ...
    models = {
        ...
        'idea.ideaargument': {
            'Meta': {'object_name': 'IdeaArgument'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idea': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['idea.Idea']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'idea.ideaargumentcomment': {
            'Meta': {'object_name': 'IdeaArgumentComment'},
            'argument': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['idea.IdeaArgument']"}),
