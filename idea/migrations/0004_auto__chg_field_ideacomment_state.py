...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdeaComment.state'
        db.alter_column('idea_ideacomment', 'state', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'IdeaComment.state'
        db.alter_column('idea_ideacomment', 'state', self.gf('django.db.models.fields.IntegerField')())
