...
MIDDLEWARE_CLASSES = (
    ...
    'utils.middleware.DomainResolverMiddleware',
)
...
PAGE_IMAGES_ROOT = 'page_images'
NEWS_IMAGES_ROOT = 'news_images'
MEMBERS_IMAGES_ROOT = 'members_images'
BLOG_ENTRY_IMAGES_ROOT = 'blog_entry'
BLOG_AUTHOR_IMAGES_ROOT = 'blog_author'

AUTH_PROFILE_MODULE = 'members.UserProfile'

GRAPPELLI_ADMIN_TITLE = 'Za grad'
GRAPPELLI_INDEX_DASHBOARD = 'utils.dashboard.CustomIndexDashboard'

GEOIP_PATH = ABS_PATH('..', 'data', 'GeoIP', 'GeoLiteCity.dat')

TWITTER_PAGE = 'https://twitter.com/za_grad'
FACEBOOK_PAGE = 'http://www.facebook.com/StrankaZaGrad'

COMMENT_MAXLENGTH = 500

IDEA_POINT = 10
VOTE_POINT = 1
IDEA_VOTE_DIFF_POINT = 1
...
NOREPLY_EMAIL = 'noreply@za-grad.com'
