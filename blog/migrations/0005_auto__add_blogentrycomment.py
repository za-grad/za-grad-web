...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogEntryComment'
        db.create_table('blog_blogentrycomment', (
        ...
        db.send_create_signal('blog', ['BlogEntryComment'])


    def backwards(self, orm):
        # Deleting model 'BlogEntryComment'
        db.delete_table('blog_blogentrycomment')
    ...
    models = {
        ...
        'blog.blogentrycomment': {
            'Meta': {'object_name': 'BlogEntryComment'},
